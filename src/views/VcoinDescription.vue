<template>
  <div class="body">
    <!--廣告-->
    <div class="ad margin-top-bottom-10"></div>
    <!--第一列-->
    <div id="onetitle" class="title margin-bottom-5" @click="show('one')">
      <div class="column">
...
.gotobuy {
  ...
  background-image: linear-gradient(131deg, #f3806f 31%, #f8758d 77%);
  font-family: STHeitiTC;
  font-size: 0.8125rem;
  font-weight: 300;
  font-stretch: normal;
